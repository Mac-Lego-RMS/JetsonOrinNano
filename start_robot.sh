...
sleep 5
if docker exec "$CONTAINER" v4l2-ctl -d /dev/video0 \
        -c auto_exposure=1 \
    ...
    echo "Kamera: feste Belichtung $((CAM_EXPOSURE / 10)) ms, Saettigung $CAM_SATURATION, gain $CAM_GAIN, Weissabgleich fest $CAM_WB_TEMP K."
else
