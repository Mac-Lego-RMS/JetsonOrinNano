            ...
            if detected_obstacles:
                ...
                if self.is_start_finish_straight and zone_id is not None:
                    ...
                    if self.fahrtrichtung == 'links' and zone_id == 20:
                        self.get_logger().warn(f"Hindernis sollte auf 20 gesetzt werden, was aber nicht möglich ist")
                        return current_obstacle
                    elif self.fahrtrichtung == 'rechts' and zone_id == 10:
                        self.get_logger().warn(f"Hindernis sollte auf 10 gesetzt werden, was aber nicht möglich ist")
                        return current_obstacle
